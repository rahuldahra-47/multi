  ...
  return (
    <div>
         <div className="text-center ">
          ...
          <p className="mb-12 text-xl font-normal text-center text-gray-500 dark:text-gray-900">
          ...
          <div className="flex flex-col items-center md:flex-row justify-center">
            <div className="p-4">
              ...
              <div className="text-center">
                ...
                <p className="text-xl font-light text-gray-500 dark:text-gray-700">
                  Full Stack Developer
                </p>
                <p className="max-w-xs py-4 font-light text-gray-500 text-md dark:text-gray-900">
              ...
              <div className="flex items-center justify-between pt-8 mx-auto text-gray-500 border-t border-gray-200 w-44">
                <Link href="https://www.facebook.com/rahul.dahra.37">
                  <svg
                    ...
                    height="30"
                    fill="currentColor"
                    className="text-xl transition-colors duration-200 hover:text-gray-800 dark:hover:text-black"
            ...
            <div className="p-4">
              ...
              <div className="text-center">
                <p className="text-2xl text-gray-800 dark:text-black">Harshit</p>
                <p className="text-xl font-light text-gray-500 dark:text-gray-700">
                  Front End Developer
                </p>
                <p className="max-w-xs py-4 font-light text-gray-500 text-md dark:text-gray-900">
